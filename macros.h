...
"       If no argument given to cd the command will be interpretted\n"\
"       as cd $HOME.\n"\
"       if the argument help is - (cd -), the command will be interpretted\n"\
"       as cd $OLDPWD. \n\n"
...
"      initialize anew enviroment variable, or modify an existing one \n\n
